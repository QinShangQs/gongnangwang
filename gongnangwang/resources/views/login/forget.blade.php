		...
		<div class="sign_con Right">
			...
			<div class="sign_header">
				<div class="content_con">
					...
					<h3 class="sign_wor Left">忘记密码</h3>
					</p>
				</div>
			</div>
			<!-- 头部结尾 -->
			...
			<div class="sign_content">
				<div class="content_con">
						...
						<div class="sign_yanz">
							...
							<span class="inpt_but Right" id="checkPhone"
								onclick="settime(this)">获取验证码 </span>
						</div>
						<!--密码-->
						...
						<p class="wrid Both">
							<label for="agree"> <input type="checkbox" name="agree"
								id="agree" value="1" /> 阅读并同意共囊网的《共囊网服务协议》 《法律声明 及隐私政策》
								《支付宝服务协议》
							</label>
						</p>
						<div class="sign_but">
			...
			<div class="three_con">
				<ul class="content_con">
					<li class="three_con_one_li"><a href="javascript:;"><img
							src="images/login-biao.png" /></a></li>
...
<script type="text/javascript">
    ...
    function settime(val){
        ...
        if(!pattern.test(phone))
        {
            ...
            if (countdown == 0) {
                ...
                $('#checkPhone').css('background-color','#db0011').html("获取验证码");
                countdown = 60;
            } else {
                if(countdown==60){
                ...
                $('#checkPhone').css('background-color','#999999').html("重新发送(" + countdown + ")");
                countdown--;
                setTimeout(function() {
                    settime(val)
                },1000)
    ...
    $('#btn').click(function () {
        ...
        $.post("/forget",{phone:phone,verify:verify,password:password},function(obj){
        	alert(obj.msg);
        	if(obj.href){
